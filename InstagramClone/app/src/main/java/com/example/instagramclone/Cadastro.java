...
//
//                            mTxtObterDados.setText(object.get("nome") + " - " + "Força do soco: " +
//                                    object.get("forcaSoco") + " Velocidade do soco: " +
//                                    object.get("velocidadeSoco") + " Força do chute: " +
//                                    object.get("forcaChute") + " Velocidade do chute: " +
//                                    object.get("velocidadeChute") );
//                        }
//                    }
//
//                });
...
//                                }
//                                FancyToast.makeText(Cadastro.this, mTodosLutadoresMMA, FancyToast.LENGTH_LONG,
